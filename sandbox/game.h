...
enum class EnemyType { Chaser, Tank, Swarmer, Boss };
...
private:
    ...
    kairo::HierarchySystem m_hierarchy;
    kairo::TimerManager m_timers;
    kairo::TweenManager m_tweens;
    kairo::WaveSpawner m_wave_spawner;
    ...
    // tween targets for HUD animations
    float m_score_display = 0.0f;
    float m_combo_flash = 0.0f;

    void setup_particles();
    void setup_tilemap();
    void setup_wave_spawner();
    void spawn_player();
    void spawn_shield(kairo::Entity player);
    void spawn_wave();
    void spawn_enemy(EnemyType type, const kairo::Vec2& pos);
    void spawn_boss(const kairo::Vec2& pos);
    void spawn_walls();
    void spawn_pickup();
    ...
    bool check_line_of_sight(const kairo::Vec2& from, const kairo::Vec2& to);
};
...
private:
    ...
    int m_final_kills;
    float m_time = 0.0f;
    float m_title_y = 200.0f;
    float m_stats_alpha = 0.0f;
    kairo::TweenManager m_tweens;
};
...
private:
    ...
    kairo::ProfilerPanel m_profiler_panel;
